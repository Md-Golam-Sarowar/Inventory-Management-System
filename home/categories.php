	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		if (isset($_POST['insert'])) {
			...
			if($link === false)
			{
				...
				$sql = "INSERT INTO category (name,root) VALUES ('$name','$root')";
		...
		if (isset($_POST['update'])){
				...
				$root = test_input($_POST["updateroot"]);
			if($link === false)
			{
				die("ERROR: Could not connect. " . mysqli_connect_error());
			}
				$sql = "update category set name='$name',root='$root' where id=$id";
				if(mysqli_query($link, $sql)){
				echo "Records inserted successfully.";
			} else{
				echo "ERROR: Could not able to execute $sql. " . mysqli_error($link);
	...
	<body>
		...
		<div class="container">
			<div class="jumbotron">
					<div class="row">	
						<div class="col-md-3">
							<button type="button" class="btn btn-info" data-toggle="modal" data-target="#add" style="width:100%; font-size:20px">Add Category</button>
						</div>
						  ...
						  <div class="modal-body">
							<form method="post" action="">							
								...
								<div class="form-group input-group">
									...
									<input type="text" name ="root" class="form-control"  placeholder="Enter root"  required>
								</div>
												  ...
												  <div class="modal-body">
													<form method="post" action="">							
														...
														<div class="form-group input-group">
															...
															<input type="text" name ="updateroot" class="form-control"  value="<?php echo $r['root']; ?>">
														</div>
